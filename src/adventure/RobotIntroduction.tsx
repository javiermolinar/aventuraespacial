...
export function RobotIntroduction({ robot, introduction, playerName, assetPrefix, onNext, children }: {
  ...
  return <>
    ...
    <article className="dialogue-dock robot-introduction" aria-labelledby="robot-introduction-title">
      ...
      <h1 id="robot-introduction-title" ref={heading} tabIndex={-1}>{robot.name}{introduction.title !== robot.name && <>{' '}<span>{personalize(introduction.title, playerName)}</span></>}</h1>
